package net.zdsoft.zerobook.common.component.clip;
...
public class ClipImageBorderView extends View {
	...
	protected void onDraw(Canvas canvas) {
		super.onDraw(canvas);
		int LAYER_FLAGS = Canvas.MATRIX_SAVE_FLAG | Canvas.CLIP_SAVE_FLAG | Canvas.HAS_ALPHA_LAYER_SAVE_FLAG 
		...
		// 绘制矩形裁剪框
			...
			// 绘制中间的矩形
			canvas.drawRect(mHorizontalPadding, this.getHeight() / 2 - clipWidth / 2, this.getWidth() - mHorizontalPadding, 
					this.getHeight() / 2 + clipWidth / 2, paint);
			// 绘制白色的矩形边框
			canvas.drawRect(mHorizontalPadding, this.getHeight() / 2 - clipWidth / 2, this.getWidth() - mHorizontalPadding,
					this.getHeight() / 2 + clipWidth / 2, borderPaint);
		}
	...
	public void setmHorizontalPadding(float mHorizontalPadding) {
		...
		this.clipRadiusWidth = (int) (Util.getWindowWidth(getContext()) - 2 * mHorizontalPadding) / 2;
